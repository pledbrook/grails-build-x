...
/**
 * Custom version of Groovy's standard DOM category that can be used
 * with plugin doWithWebDescriptor implementations.
 * @author Peter Ledbrook
 *
 * Based on a copy of DOMCategory at svn revision 19278.
 * @author sam
 * @author paulk
 */
public class GrailsDOMCategory {
    ...
    private static Node xgetAt(NodeList nodeList, int i) {
        if (i >= 0) {
            ...
            return nodeList.item(nodeList.getLength() + i);
        }
        return null;
    }
    ...
    private static final class NodeListsHolder implements NodeList {
        ...
        public String toString() {
            return GrailsDOMCategory.toString(this);
        }
    }
